...
function responsive_mobile_js() {
	...
	wp_enqueue_script( 'responsive-scripts', $template_directory_uri . '/js/responsive-scripts' . $suffix . '.js', array( 'jquery' ), '1.2.6', true );
	...
	wp_enqueue_script( 'responsive-skip-link-focus-fix' );
